export default {
  baseStyle: {
    ...
    otherConfig: '其他設定',
    associativeLine: '關聯線',
    associativeLineWidth: '線條寬度',
    associativeLineColor: '線條顏色',
    associativeLineActiveWidth: '啟用時的線條寬度',
    associativeLineActiveColor: '啟用時的線條顏色',
    rootStyle: '根節點',
    ...
    tagPosition: '節點標籤的位置',
    tagPositionRight: '文字右側',
    tagPositionBottom: '文字下方',
    alwaysShowExpandBtn: '是否永遠顯示展開收合按鈕',
    enableAutoEnterTextEditWhenKeydown: '輸入時自動進入文字編輯'
  },
  setting: {
    title: '設定',
    ...
    createNewNodeBehavior: '建立新節點動作',
    default: '啟用新節點並進入編輯',
    notActive: '不啟用新節點',
    activeOnly: '僅啟用新節點，不進入編輯',
    openRealtimeRenderOnNodeTextEdit: '開啟文字編輯即時渲染效果',
    isShowScrollbar: '顯示滾動條',
    isUseHandDrawnLikeStyle: '使用手繪風格',
    watermark: '浮水印',
    showWatermark: '顯示浮水印',
    onlyExport: '僅在匯出時顯示',
    watermarkDefaultText: '浮水印內容',
    watermarkText: '浮水印文字',
  ...
  contextmenu: {
    insertSiblingNode: '新增同層節點',
    insertChildNode: '新增子節點',
    insertParentNode: '新增父節點',
    insertSummary: '新增摘要',
    moveUpNode: '節點上移',
    moveDownNode: '節點下移',
    deleteNode: '刪除節點',
    deleteCurrentNode: '只刪除目前節點',
    copyNode: '複製節點',
    cutNode: '剪下節點',
    pasteNode: '貼上節點',
    backCenter: '回到根節點',
    ...
    copyFail: '複製失敗',
    number: '編號子節點',
    expandNodeChild: '展開所有子節點',
    unExpandNodeChild: '收合所有子節點',
    addToDo: '新增待辦事項',
    removeToDo: '刪除待辦事項'
  },
  count: {
  ...
  export: {
    ...
    isTransparent: '背景透明',
    pngTips: '提示：豐富文字模式匯出圖片時間較久，建議使用 SVG 格式',
    svgTips: '提示：豐富文字模式匯出圖片時間較久',
    transformingDomToImages: '正在轉換節點...',
    notifyTitle: '通知',
    notifyMessage: '如果下載沒有啟動，請檢查是否被瀏覽器封鎖',
    paddingX: '水平內距',
    paddingY: '垂直內距',
    useMultiPageExport: '多頁匯出',
    defaultFileName: '心智圖',
    addFooterText: '新增底部文字',
